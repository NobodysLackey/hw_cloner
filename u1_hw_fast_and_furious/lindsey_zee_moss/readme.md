...
*_Please create individual functions for each solution. Don't forget to **invoke()** the function once you're finished._*
...
- [JS DOM Lesson](https://github.com/SEI-R-4-26/u1_lesson_DOM)
- [JS Arrays Lesson](https://github.com/SEI-R-4-26/u1_lesson_js_arrays)
